...
export CPPFLAGS HOMEBREW_BUNDLE_FILE HOMEBREW_BUNDLE_NO_LOCK LDFLAGS PIP_REQUIRE_VIRTUALENV PKG_CONFIG_PATH POWERSHELL_UPDATECHECK PYENV_VIRTUALENV_DISABLE_PROMPT XDG_CACHE_HOME XDG_CONFIG_HOME XDG_DATA_HOME XDG_STATE_HOME
